                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="general" role="tabpanel" aria-labelledby="general-tab">
                        <div class="bg-white p-3 p-sm-2rem">
                            ...
                            <!-- Flash Deal -->
                            <h5 class="mb-3 mt-4 pb-3 fs-17 fw-700" style="display: none; border-bottom: 1px dashed #e4e5eb;">
                    ...
                    <div class="tab-pane fade" id="price_and_stocks" role="tabpanel" aria-labelledby="price-and-stocks-tab">
                        <div class="bg-white p-3 p-sm-2rem">
                            ...
                            <div class="w-100">
                                <!-- Colors -->
                                <div class="form-group row gutters-5" style="display: none">
                                    <div class="col-md-3">
                                ...
                                @if(addon_is_activated('club_point'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="number" lang="en" min="0" value="{{ $product->malaysian_points }}" step="1" placeholder="{{ translate('1') }}" name="malaysian_points" class="form-control">
                                        </div>
                                    </div>
                                @endif
