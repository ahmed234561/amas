                                ...
                                <div class="pt-3">
                                    <div class="">
                                        <form id="reg-form" class="form-default" role="form" action="{{ route('register') }}" method="POST">
                                            ...
                                            <div class="form-group">
                                                <label for="phone" class="fs-12 fw-700 text-soft-dark">{{  translate('phone') }}</label>
                                                <input type="phone" class="form-control rounded-0{{ $errors->has('phone') ? ' is-invalid' : '' }}" value="{{ old('phone') }}" placeholder="{{  translate('phone') }}" name="phone">
                                                @if ($errors->has('phone'))
                                                    <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label for="postal_code" class="fs-12 fw-700 text-soft-dark">{{ "ادخل رقم العضوية" }}</label>
                                                    <input type="number" class="form-control rounded-0 @error('postal_code') is-invalid @enderror" value="{{ old('postal_code') }}" placeholder="{{  "ادخل رقم العضوية"  }}" name="postal_code">
                                                    @error('postal_code')
                                                    <span class="invalid-feedback" role="alert">
