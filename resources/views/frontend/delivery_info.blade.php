                                        ...
                                        <div class="row pt-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row gutters-5">
                                                    ...
                                                    {
                                                        $address_id = $one_cart->address_id;
                                                    }
                                                    ?>
                                                    @if($address_id != null)
                                                    <?php
                                                    $shipping_info = \App\Models\Address::find($address_id);
                                                    ?>
                                                    @if($shipping_info->state_id != 3163)<!-- الرياض -->
...
<script>
    $(function(){
        $('.coveredPickupPointRadio').click(function(){

            var $this = $(this);
            var $target = $('.coveredPickupPoint');
            console.log('Done');

            if($this.is(':checked')){
                $target.addClass('checked', true);
                $target.prop('checked', true);
            }else{
                $target.removeClass('checked', true);
