        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    {!! $order->additional_info_data("table-borderless table") !!}
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-body pb-0" style="padding: 0px !important;">
                    <table class="table-borderless table">
                        <tbody>
                            ...
                            <?php
                            $pickup_point = \App\Models\PickupPoint::find($order->pickup_point_id);
                            ?>
                            @if($pickup_point != null)
                            <tr>
                                <td class="w-50 fw-600">{{  $pickup_point->getTranslation('name') }}</td>
                                <td class="text-right">
                                    <span class="text-italic">{{ single_price($pickup_point->phone) }}</span>
                                </td>
                            </tr>
                            @endif
                            <tr>
