        ...
        <div class="card-body">
            <form action="{{ route('user.profile.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    -->
                @if(isset(Auth::user()->postal_code) && Auth::user()->postal_code != null)
                <!-- Postal Code-->
                <div class="form-group row">
                    <label class="col-md-2 col-form-label fs-14">{{ translate('Code') }}</label>
                    <div class="col-md-10">
                        <input type="text" class="form-control rounded-0" readonly placeholder="{{ translate('Code')}}" name="postal_code" value="{{ Auth::user()->postal_code }}">
                    </div>
                </div>
                @endif
                <!-- Photo-->
