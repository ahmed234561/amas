            ...
            <div class="col-xxl-8 col-xl-10 mx-auto">
                <div class="border bg-white p-3 p-lg-4 text-left">
                    ...
                    <div class="px-0 py-2 mb-4 border-top d-flex justify-content-between">
                        ...
                        <span class="fw-700 fs-16 sub_total">{{ single_price($total) }}</span>
                    </div>
...
<script type="text/javascript">
    AIZ.extra.plusMinus();
    function updateQuantity(cartItemId, element) {
    ...
    $.ajax({
        ...
        success: function(response) {
            if(response.success) {
                ...
                var itemTotalElement = $(element).closest('.list-group-item').find('.text-primary');
                itemTotalElement.text(response.item_total);

                // Update the subtotal
                $('.sub_total').last().text(response.subtotal);
                    setTimeout(function() {
                ...
                element.value = response.original_quantity;
            }
        },
        error: function() {
