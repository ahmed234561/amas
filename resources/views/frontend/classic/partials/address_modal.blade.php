            ...
            <form class="form-default" role="form" action="{{ route('addresses.store') }}" method="POST">
                ...
                <div class="modal-body c-scrollbar-light">
                    <div class="p-3">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <label>{{ translate('رابط موقعك الجغرافي')}}</label>
                            </div>
                            <div class="col-md-10">
                                <input type="text" class="form-control mb-3 rounded-0" placeholder="{{ translate('رابط موقعك الجغرافي')}}" name="postal_code" value="" required>
                            </div>
                        </div>
