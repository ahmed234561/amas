                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="col-auto pl-0 pr-3 d-flex align-items-center">
                        <a class="d-block py-20px mr-3 ml-0" href="{{ route('home') }}">
                            ...
                            @else
                                <img src="{{ static_asset('assets/img/logo.png?do=vv') }}" alt="{{ env('APP_NAME') }}"
                                    class="mw-100 h-30px h-md-40px" height="40">
                            @endif
                        </a>
                    </div>
                    ...
                    <div class="flex-grow-1 front-header-search d-flex align-items-center bg-white mx-xl-5">
                        <div class="position-relative flex-grow-1 px-3 px-lg-0">
                            <form action="{{ route('search') }}" id="search-form" method="GET" class="stop-propagation">
                    ...
                    <div class="d-none d-xl-block all-category has-transition bg-black-10" id="category-menu-bar">
                        <div class="px-3 h-100"
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <i class="las la-angle-down text-white has-transition show" id="category-menu-bar-icon"
