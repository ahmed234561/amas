...
use App\Http\Controllers\UserSpecialPriceController;
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function() {
    ...
    Route::post('/products/update-sort', 'updateSort')->name('products.updateSort');
    ...
    // Special Prices
    Route::controller(UserSpecialPriceController::class)->group(function () {
        Route::get('/special-prices', 'index')->name('special-prices.index');
        Route::post('/special-prices/store', 'store')->name('special-prices.store');
        Route::get('/special-prices/get-users/{productId}', 'getUsers')->name('special-prices.get-users');
        Route::get('/special-prices/destroy/{id}', 'destroy')->name('special-prices.destroy');
    });
});
